...
},
{
	...
	"fake_comments":["Ну что вы, здесь расположен, пожалуй, самый большой памятник Ленину в городе, который стоит здесь с 1952 года.",""],
	"title":"А где нельзя найти памятник В.И. Ленину?",
	"why_true":"Действительно, Казанский собор стоял прямо на площади графа Сперанского. Сейчас на его месте расположена областная администрация.",
}]
