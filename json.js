...
},
{
	"id":"ch_crossvosd",
	"type":"noname",
	"ll":[52.278505, 104.281092],
	"fake_locations":[[52.279412, 104.282731],[52.283136, 104.270780],[52.275488, 104.277228]],
	"true_title":"Вампилов",
	"fake_titles":["Первый объект","Второй объект","Третий объект"],
	"fake_comments":["Нет, здесь находится Ленин","Нет, здесь находится памятник сотрудникам мвд","Нет, здесь находится Александ 3"],
	"title":"Известный драматург смог прославить город в своих произведениях и записать себя в историю города. (Укажите его памятник)",
	"why_true":"Прямо в яблочко! Он находится на улице Карла Маркса рядом с фонтаном",
},
{
	"id":"ch_crossvosd",
	"type":"noname",
	"ll":[52.292640, 104.281531],
	"fake_locations":[[52.290050, 104.281559],[52.289004, 104.281881],[52.291691, 104.280071]],
	"fake_comments":["Нет, здесь находится памятник Стела Орден Ленина","Нет, здесь находится памятник Сперанскому","Нет, здесь находится Белобородов"],
	"title":"Кому принадлежат слова  «В нынешнем 169 /1661/ году июля в шестой день против Иркута реки на Верхнеленской стороне, государев новый острог служилыми людьми ставлю.» (Укажите его памятник)",
	"why_true":"Прямо в яблочко! Она находится на пересечении улиц Седова и Тимирязева.",
},
{
	"id":"ch_crossvosd",
	"type":"noname",
...
},
{
	...
	"why_true":"Правильно! Сейчас это дом Иркутской молодежи, но многие его до сих пор называют Домом офицеров, который располоагался там с 1925 до 2011 года.",
	"fake_titles":["Харлампиевская церковь","Дворец Пионеров","Преображенская церковь","Троицкая церковь"],
	"true_title":"Крестовоздвиженская церковь",
},
{
